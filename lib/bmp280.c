...
void BMP280_Set_RegCtrlMeas() {
	uint8_t ctrlMeasSet;
	ctrlMeasSet = (bmp280.conf.os_temp << 5) | (bmp280.conf.os_pres << 2)
			| (bmp280.conf.power_mode);
...
void BMP280_Set_RegConfig() {
	uint8_t configSet;
	configSet = (bmp280.conf.odr << 5) | (bmp280.conf.filter << 2)
			| (bmp280.conf.spi3w_en);
...
void BMP280_GetCalibParam() {
	...
	bmp280.calib_param.dig_p6 = ((int16_t) spiDataBuf[11] << 8)
			| spiDataBuf[10];
	bmp280.calib_param.dig_p7 = ((int16_t) spiDataBuf[13] << 8)
			| spiDataBuf[12];
	bmp280.calib_param.dig_p8 = ((int16_t) spiDataBuf[15] << 8)
			| spiDataBuf[14];
	bmp280.calib_param.dig_p9 = ((int16_t) spiDataBuf[17] << 8)
			| spiDataBuf[16];
...
int32_t BMP280_ReadPressure_Row() {
	...
	bmp280.uncomp_data.uncomp_press = ((uint32_t) spiDataBuf[0] << 12)
			| ((uint32_t) spiDataBuf[1] << 4) | ((uint32_t) spiDataBuf[2] >> 4);
...
int32_t BMP280_ReadTemperature_Row() {
	...
	bmp280.uncomp_data.uncomp_temp = ((uint32_t) spiDataBuf[0] << 12)
			| ((uint32_t) spiDataBuf[1] << 4) | ((uint32_t) spiDataBuf[2] >> 4);
...
float bmp280_calc_t_fine_int64() {
	...
	var1 = ((((adc_T >> 3) - ((int32_t) bmp280.calib_param.dig_t1 << 1)))
			* ((int32_t) bmp280.calib_param.dig_t2)) >> 11;
	var2 = (((((adc_T >> 4) - ((int32_t) bmp280.calib_param.dig_t1))
			* ((adc_T >> 4) - ((int32_t) bmp280.calib_param.dig_t1))) >> 12)
...
double BMP280_Compensate_P_double() {
	...
	var1 = (((double) bmp280.calib_param.dig_p3) * var1 * var1 / 524288.0
			+ ((double) bmp280.calib_param.dig_p2) * var1) / 524288.0;
...
float BMP280_Compensate_P_int32() {
	...
	var2 = (((var1 >> 2) * (var1 >> 2)) >> 11)
			* ((int32_t) bmp280.calib_param.dig_p6);
	var2 = var2 + ((var1 * ((int32_t) bmp280.calib_param.dig_p5)) << 1);
	var2 = (var2 >> 2) + (((int32_t) bmp280.calib_param.dig_p4) << 16);
	var1 = (((bmp280.calib_param.dig_p3 * (((var1 >> 2) * (var1 >> 2)) >> 13))
			>> 3) + ((((int32_t) bmp280.calib_param.dig_p2) * var1) >> 1))
			>> 18;
